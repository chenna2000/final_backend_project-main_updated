# Generated by Django 4.2.11 on 2024-08-01 12:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('job_portal', '0008_remove_company_sector_company_sector_type'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='company',
            name='country_type',
            field=models.CharField(choices=[('AF', 'Afghanistan'), ('AL', 'Albania'),
                                            ...
                                            ('CK', 'Cook Islands'), ('CR', 'Costa Rica'), ('CI', 'Côte dIvoire'), ('HR', 'Croatia'), ('CU', 'Cuba'),
                                            ...
                                            ('YE', 'Yemen'), ('ZM', 'Zambia'), ('ZW', 'Zimbabwe')], default='India', max_length=200),
        ),
    ]
